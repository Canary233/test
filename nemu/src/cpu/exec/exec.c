...
opcode_entry opcode_table [512] = {
  ...
  /* 0x74 */	IDEX(J,jcc), IDEX(J,jcc), IDEXW(J,jcc,1), IDEX(J,jcc),
  ...
  /* 0xb8 */	EMPTY, EMPTY, IDEXW(mov_E2G,movzx,1), IDEXW(mov_E2G,movzx,2),
